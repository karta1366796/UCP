<template>
  <div class="grid">
    ...
    <div class="col-12 xl:col-6">
      <div class="card">
        <h5>Recent Sales</h5>
        <DataTable :paginator="true" :rows="5" :value="products" responsive-layout="scroll">
      ...
      <div class="card">
        ...
        <ul class="p-0 mx-0 mt-0 mb-4 list-none">
          ...
          <li class="flex align-items-center py-2">
            ...
            <span class="text-700 line-height-3">
              Your request for withdrawal of <span class="text-blue-500 font-medium">2500$</span> has been initiated.
            </span>
          </li>
        </ul>
        ...
        <ul class="p-0 m-0 list-none">
          ...
          <li class="flex align-items-center py-2 border-bottom-1 surface-border">
            ...
            <span class="text-900 line-height-3">
              Jane Davis<span class="text-700">has posted a new questions about your product.</span>
            </span>
          </li>
        </ul>
      </div>
...
export default defineComponent({
  setup() {
    const productService = ref<ProductService>(new ProductService());
    const themeChangeListener = ref<(event: Event) => void>();
    const lineOptions = ref<object>();
    const products = ref<object>();

    return { productService, themeChangeListener, lineOptions, products };
  },
  data() {
    return {
      lineData: {
  ...
  mounted() {
    this.productService.getProductsSmall().then((data: object) => (this.products = data));
